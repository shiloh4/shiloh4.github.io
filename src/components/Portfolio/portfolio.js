...
const projects = [
    ...
    },
    {
        ...
        paragraphs: [
            'I have numerous other projects that I\'m currently working on, with the aim of familiarizing myself with new technologies, frameworks, and techniques to better myself at web development. Some of them include a site that aims to demonstrate the mechanisms of Q-Learning algorithms, with visual simulations of agents learning to nagivate complex mazes. This project means a lot to me as it can be used as a teaching tool for many students hoping to learn more about reinforcement learning. I\'m working with a PhD student to bring this project to life, and our goal would be to submit this project + a paper to AAAI\'s education track some time in 2026.',
