        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                width: 'auto'}}>
                    ...
                    <Typography variant="body2" sx={{ mb: 3 }}>
                        I am currently a Computer Science junior at Georgia Tech, with prior experience as a QA engineer with Keysight. My academic threads are <Link href="https://www.cc.gatech.edu/academics/threads/information-internetworks" underline="hover" target="_blank" rel="noopener" sx={{color: theme.palette.link.primary}}>Information Internetworks</Link> and <Link href="https://www.cc.gatech.edu/academics/threads/media" underline="hover" target="_blank" rel="noopener" sx={{color: theme.palette.link.primary}}>Media</Link>.
                    </Typography>
